import { useState, useRef, useEffect } from 'react'; // <--- ESTA LÍNEA ES CRÍTICA
import { Printer, Settings2, Bot, FileText, Columns, ZoomIn, ZoomOut, Maximize } from 'lucide-react';
...
export const PreviewPanel = () => {
  ...
  const [zoom, setZoom] = useState(0.8); // Zoom inicial
  ...
  // Ajustar zoom con límites
  const handleZoom = (delta: number) => {
    setZoom(prev => Math.max(0.3, Math.min(2, prev + delta)));
  };

  // Dimensiones físicas según formato para calcular las guías visuales
  const pageSize = settings.paperSize === 'A4' 
    ? { width: '210mm', height: '297mm', heightMm: 297 }
    : { width: '8.5in', height: '11in', heightMm: 279.4 };
      ...
      <div className="flex-1 overflow-auto p-8 flex justify-center items-start bg-gray-900/50 print:p-0 print:overflow-visible print:bg-white relative">
        ...
        >
            ...
            >
              ...
              {/* --- INDICADORES DE SALTO DE PÁGINA --- */}
